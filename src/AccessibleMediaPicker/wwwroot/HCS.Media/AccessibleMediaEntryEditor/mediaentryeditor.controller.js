angular.module("umbraco")
    .controller("HCS.AccessibleMediaEntryEditorController",
        function ($scope, localizationService, entityResource, editorService, overlayService, eventsService, mediaHelper) {
          ...
          vm.close = close;
          vm.toggleDecorativeState = toggleDecorativeState;
          ...
          function toggleDecorativeState() {
            vm.mediaEntry.isDecorative = !vm.mediaEntry.isDecorative;
          }
