(function () {
    ...
    /**
     * @ngdoc directive
     * @name hcs.directives.directive:umbAccessibleMediaPicker3PropertyEditor
     * @function
     *
     * @description
    ...
    angular
        .module("umbraco")
      .component("hcsAccessibleMediaPickerPropertyEditor", {
            templateUrl: "/App_Plugins/HCS.Media/AccessibleMediaPicker/hcs-accessible-media-picker-property-editor.html",
            controller: AccessibleMediaPickerController,
            controllerAs: "vm",
            bindings: {
                model: "=",
                node: "="
  ...
  function AccessibleMediaPickerController($scope, $element, editorService, clipboardService, localizationService, overlayService, userService, entityResource, $attrs, umbRequestHelper, $injector, uploadTracker, editorState) {
      ...
      vm.$onInit = function() {
            ...
            if (!vm.node?.key) {
              console.warn('An AccessibleMediaPicker did not detect a valid content node and disabled drag & drop.', $element[0]);
        ...
        function editMedia(mediaEntry, options, $event) {
            ...
            const mediaEditorModel = {
                ...
                view: "/App_Plugins/HCS.Media/AccessibleMediaEntryEditor/mediaentryeditor.html",
                size: "large",
                submit: function(model) {
